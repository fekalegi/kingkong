...
const TableSales: React.FC<TableSalesProps> = ({ data, handleDelete }) => {
  if (!data) {
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button className="hover:text-primary" onClick={() => {router.push(`/sales/view?id=${packageItem.transaction_id}`)}}>
                      <svg

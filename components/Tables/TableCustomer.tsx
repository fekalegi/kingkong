...
const TableCustomer: React.FC<TableCustomerProps> = ({ data, handleDelete }) => {
  if (!data) {
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button className="hover:text-primary" onClick={() => {router.push(`/customer/edit?id=${packageItem.customer_id}`)}}>
                      <svg
                    ...
                    <button className="hover:text-primary" onClick={() => handleDeleteClick(packageItem.customer_id)}>
                      <svg
                        className="fill-current"
                        width="18"
                        height="18"

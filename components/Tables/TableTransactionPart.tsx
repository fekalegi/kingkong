...
interface TableTransactionPartProps {
  data: TransactionPart[];
  handleDelete: (key: number) => Promise<void>;
}

const TableTransactionPart: React.FC<TableTransactionPartProps> = ({ data, handleDelete }) => {
  if (!data) {
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button type="button" className="hover:text-primary" onClick={(e) => handleDeleteClick(key)}>
                      <svg
...
export default TableTransactionPart;
